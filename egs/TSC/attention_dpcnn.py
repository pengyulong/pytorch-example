...
utils.setup_seed(2020)#设置随机数种子,保证结果可复现
...
class Job:
    def __init__(self):
        ...
        self.writer = SummaryWriter(logdir=os.path.join(self.model_dir,"runs"))
    ...
    def train(self):
        ...
        valid_loss, train_loss = utils.train_and_evaluate(model,train_dataloader,valid_dataloader,optim,criterion,utils.metrics,self.epoches,model_dir=self.model_dir,restore_file=None)
